...
public class Movie {
	...
	try(Connection connection = DriverManager.getConnection(JDBC.URL.getValue(),JDBC.USERNAME.getValue(),JDBC.SECRETS.getValue())){
		...
		//CREATE TABLE Movie (1Movie_Name varchar(20),2Hero_Name VARCHAR(20),H3eroine_Name VARCHAR(20),4Villan_Name VARCHAR(30),5Budget bigint,
		//6Language VARCHAR(30),7Studio_location VARCHAR(30),8Script_Writer VARCHAR(30),9Digalouge_Writer VARCHAR(30),10stunt_Master VARCHAR(30),11Cinematographer varchar(30),
		//12State varchar(30),13Crew_Members int,14Poduction_house varchar(20),15Certificate varchar(10),16Item_song tinyint,17Total_Songs int,18Total_Time time,
		//19Poroducer_Name varchar(20),20Director varchar(20),21Music_Director varchar(20),22Screnplay varchar(20),23Action tinyint,24Comdey tinyint,
		//25Family_entertainer tinyint,26Drama tinyint,27Register_id int,28Distributor varchar(20),29OTT tinyint,30Realse_Date date,31Total_Members_Film int,
